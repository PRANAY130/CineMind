...
import { User, Shield, Zap, Bell, Globe, Camera } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6">
          ...
          <div className="space-y-6">
            <Card className="glass-panel p-6 border-white/5 bg-white/[0.02] flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-bold tracking-tight">Shreya Paladhi</h2>
              <p className="text-[11px] text-slate-500 font-bold uppercase tracking-widest mt-1">ID: #SYS_894_221</p>
              ...
              <div className="w-full space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-bold text-slate-200">12 Active</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-slate-500 uppercase">Storage</span>
                  <span className="text-[10px] font-bold text-slate-200">2.4 TB / 5 TB</span>
                </div>
              </div>
            </Card>
          ...
          <div className="space-y-6">
            <Card className="glass-panel p-8 border-white/5 bg-white/[0.02]">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input 
                    defaultValue="iamshreyapaladhi@gmail.com"
                    className="h-10 bg-white/[0.03] border-white/5 text-xs font-medium focus:border-purple-500/50"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input defaultValue="Shreya" className="h-10 bg-white/[0.03] border-white/5 text-xs font-medium" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Last Name</label>
                    <Input defaultValue="Paladhi" className="h-10 bg-white/[0.03] border-white/5 text-xs font-medium" />
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                { icon: Shield, label: "Security", value: "Biometric Locked" }
              ].map((setting, i) => (
